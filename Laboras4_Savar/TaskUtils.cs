namespace Laboras4_Savar
{
	static class TaskUtils
	{
        ...
        public static void GetAllDogs(Branch[] ba, int NumberOfBranches, ref Branch allDogs, string forma)
        {
        ...
        public static void GetAllCats(Branch[] ba, int NumberOfBranches, ref Branch allCats, string forma)
        {
            for (int i = 0; i < NumberOfBranches; i++)
            {
        ...
        public static void GetAllGuineaPigs(Branch[] ba, int NumberOfBranches, ref Branch allGuineaPigs, string forma)
        {
            for (int i = 0; i < NumberOfBranches; i++)
            {
                Branch guinea = GetAnimals(ba[i], forma, typeof(GuineaPig));
                allGuineaPigs += guinea;
            }
        }
    }
}
